...
//
let css2DObject;
let css2DObjectLength;

// 3D渲染器
// const labelRenderer3 = new CSS3DRenderer();
...
function addCSS2DLWH(xLen, yLen, zLen) {
    var element = document.getElementById("WebGL-output-length");
    css2DObjectLength = new CSS2DObject(element);
    css2DObjectLength.position.x = 0;
    css2DObjectLength.position.y = yLen / 2 + 50;
    css2DObjectLength.position.z = 0;
    var dom = document.getElementById("lableLength");
    dom.textContent = zLen;
    scene.add(css2DObjectLength);
};
// 初始化纸箱(车箱)
